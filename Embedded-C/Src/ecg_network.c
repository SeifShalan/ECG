...
#define AI_ECG_NETWORK_MODEL_SIGNATURE     "084fcb8c8056673c7d71383d802246e9"
...
#define AI_TOOLS_DATE_TIME   "Mon May 25 16:07:58 2020"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 50, 5, 1, 1), AI_STRIDE_INIT(4, 4, 200, 1000, 1000),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 50, 50, 1, 1), AI_STRIDE_INIT(4, 1, 50, 2500, 2500),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 187, 50, 1, 1), AI_STRIDE_INIT(4, 1, 187, 9350, 9350),
  1, &dense_1_weights_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  input_0_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 187, 1, 1), AI_STRIDE_INIT(4, 4, 4, 748, 748),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 400, 1,
                     NULL),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_ECG_NETWORK_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_ECG_NETWORK_OUT_NUM, &dense_3_nl_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    dense_2_output_array.data = AI_PTR(activations + 200);
    dense_2_output_array.data_start = AI_PTR(activations + 200);
    dense_2_nl_output_array.data = AI_PTR(activations + 200);
    dense_2_nl_output_array.data_start = AI_PTR(activations + 200);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_3_bias_array.data = AI_PTR(weights + 15300);
    dense_3_bias_array.data_start = AI_PTR(weights + 15300);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 14300);
    dense_3_weights_array.data_start = AI_PTR(weights + 14300);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights + 14100);
    dense_2_bias_array.data_start = AI_PTR(weights + 14100);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 11600);
    dense_2_weights_array.data_start = AI_PTR(weights + 10576);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 10376);
    dense_1_bias_array.data_start = AI_PTR(weights + 10376);
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= ecg_network_configure_weights(net_ctx, &params->params);
  ok &= ecg_network_configure_activations(net_ctx, &params->activations);
