...
#ifndef __AI_ECG_NETWORK_H__
#define __AI_ECG_NETWORK_H__
#pragma once

#include "ai_platform.h"

#define AI_ECG_NETWORK_MODEL_NAME          "ecg_network"

#define AI_ECG_NETWORK_IN_NUM       (1)
#define AI_ECG_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 187, 1, NULL), \
}
#define AI_ECG_NETWORK_IN_SIZE { \
  (1 * 1 * 187), \
}
#define AI_ECG_NETWORK_IN_1_SIZE  (1 * 1 * 187)
#define AI_ECG_NETWORK_IN_1_SIZE_BYTES  ((1 * 1 * 187) * 4)




#define AI_ECG_NETWORK_OUT_NUM      (1)
#define AI_ECG_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 5, 1, NULL), \
}
#define AI_ECG_NETWORK_OUT_SIZE { \
  (1 * 1 * 5), \
}
#define AI_ECG_NETWORK_OUT_1_SIZE  (1 * 1 * 5)
#define AI_ECG_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 5) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup ecg_network
 ...
 * @ref ai_ecg_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_ecg_network_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_ECG_NETWORK_*
 * defines into file @ref ecg_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_ecg_network_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_ECG_NETWORK_H__*/
